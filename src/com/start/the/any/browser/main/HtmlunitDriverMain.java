...
public class HtmlunitDriverMain {
	...
	public static void main(String[] args) {
		HtmlunitDriverMain example = new HtmlunitDriverMain();
	...
	public void testHtmlUnitDriver() {
		...
		try {
			...
			/*
			 * If you want to see the browser interaction, you can uncomment
			 * below code to use Firefox to run this test script. //assign
			 * webdriver executable file path to the value of system variable
			 * System.setProperty("webdriver.gecko.driver",
			 * "C:\\Workspace\\dev2qa.com\\Lib\\geckodriver-v0.16.1-win64\\geckodriver.exe"
			 * ); //Initiate a browser driver = new FirefoxDriver();
			 */
			...
			By byXPathResultList = By
					.xpath("//*[@id=\"b_results\"]/li[@class=\"b_algo\"]");
			...
			if (resultElementList != null) {
				...
				for (int i = 0; i < size; i++) {
					...
					WebElement titleElement = resultElement
							.findElement(byXPathTitle);
					String title = titleElement.getText();
					System.out.println(title);
					System.out.println();

					// Get the result description from curent result item by
					// xpath.
					By byXPathDesc = By.xpath(".//p");
					WebElement descElement = resultElement
							.findElement(byXPathDesc);
